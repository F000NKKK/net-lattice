...
mod tests {
    ...
    /// `net_lattice` table, unlike `lib.rs`'s route/address/neighbor
    ...
    /// state and produce exactly the kind of order-dependent,
    ...
    /// serialize against `lib.rs`'s own `kernel_test_guard`, since no
