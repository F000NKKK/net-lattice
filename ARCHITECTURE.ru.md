...
разных исходных файлов. Ожидается, что будущий подраздел уровня
"дополнений" (opt-in, ненативные возможности поверх этой матрицы) расширит
этот раздел, а не продублирует его.
...
Ожидается, что этот раздел получит дополнительный подраздел, покрывающий
события из источников уровня "дополнений" (addition-sourced events —
ненативные, opt-in producers событий поверх этого нативного пути событий),
когда эта возможность появится; расширяйте этот раздел на месте, а не
создавайте второй, конкурирующий раздел "Гарантии доставки событий" в
